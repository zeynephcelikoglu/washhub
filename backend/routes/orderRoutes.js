...
router.patch('/:orderId/accept', auth, checkRole(['courier']), orderController.acceptCourier);
router.patch('/:orderId/reject', auth, checkRole(['courier']), orderController.rejectCourier);
